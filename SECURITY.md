...
This policy applies to the dokieli Web Access Control codebase. Vulnerabilities in third-party libraries should be reported upstream unless directly impacting this library's usage of them.
